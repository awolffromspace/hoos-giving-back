...
class process_splitsTests(TestCase):
    ...
    def test_exception4(self):
        splits = views.process_splits('text')
        self.assertTrue(splits[0] == -1)